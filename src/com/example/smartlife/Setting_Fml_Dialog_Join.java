...
public class Setting_Fml_Dialog_Join extends Dialog implements OnClickListener{
	...
	public Setting_Fml_Dialog_Join(Context context, int theme, Setting_Fml_Dialog_Join_DialogListener listener) {
		super(context, theme);
		this.context = context;
	...
	private void initViews(){
		...
		text = (EditText) findViewById(R.id.dialog_fml_join_edit);//暂时没有用到
