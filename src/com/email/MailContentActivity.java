...
public class MailContentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.left_mail_yj_titlebar);
    ...
    private void init() {
        ...
        btn_relay = (ImageView) findViewById(R.id.btn_relay);
